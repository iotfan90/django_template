...
(function($) {
    ...
    */
    Canvas.prototype.getSVGLayer = function(classes) {
        ...
        if (!layer) {
            ...
            layer = document.createElementNS('https://www.w3.org/2000/svg', 'g');
    ...
    */
    Canvas.prototype.getTextInfo = function(layer, text, font, angle, width) {
        ...
        if (!info) {
            var element = document.createElementNS('https://www.w3.org/2000/svg', 'text');
    ...
    var addTspanElements = function(text, element, x) {
        ...
        for (i = 0; i < lines.length; i++) {
            if (!element.childNodes[i]) {
                tspan = document.createElementNS('https://www.w3.org/2000/svg', 'tspan');
